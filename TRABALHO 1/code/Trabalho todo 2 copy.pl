...
% (invariante de insercao: deve começar com +)
% Verifica que o campo Idade na consulta coincide com a idade calculada
% a partir da data de nascimento do paciente na data da consulta.
% Ex.: +consulta(... ) :: idade_corresponde_si(..., verdadeiro).
